...
This viewpoint has correspondences with various other viewpoints, including functional safety, security, privacy, and the other SoS viewpoint that focuses on the engineering of the overall SoS. Moreover, this viewpoint has also correspondences with the topology, cost, variability, 
%
%\begin{itemize}
