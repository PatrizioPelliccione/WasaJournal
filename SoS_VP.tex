...
We \chg{foreseen}{foresee} two different viewpoints\eric{But this is \textbf{the} system of systems viewpoint. Should it then be two sub-viewpoints?}  and views: (i) %one viewpoint and view showing the architecture 
