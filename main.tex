...
architecture framework able to cope with the complexity and needs of present and future vehicles.   \eric{need to mention viewpoints and scenarios? Since the three viewpoints we present seem to be crucial, we probably should mention them here?}
\ins{Specifically, we present scenarios that describe demands for the architectural framework and introduce three new viewpoints that need to be taken into account for future architectural decisions: Continuous Integration and Deployment, Ecosystem and Transparency, and System of Systems.
...
most advanced cars have more\chg{/}{ or at least }comparable \ins{amounts of} software than fighter
...
%increase of embedded software, 
creates new challenges regarding \ugh{software
architecture}\eric{but this paper is not about software architecture, is it?} development and maintenance. 
...
Within the project we are investigating the possibility to create a Volvo Cars Architecture Framework \del{\cite{42010}}. %tailored to the needs of Volvo Cars. In this paper we refer to the conceptual foundations of
