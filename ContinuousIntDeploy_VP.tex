...
\ins{There are two types of dependencies, real and accidental dependencies. As car get more and more dependent on different sensors that also increase the dependencies in the overall system. This type of dependencies needs to be handle.  One the other hand accidental dependencies should be removed.  Dependencies can hamper team to work in isolation.} 
