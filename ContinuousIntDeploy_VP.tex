...
\section{Continuous Integration and Deployment viewpoint}
%%%%%%%%%%
...
\begin{itemize}
\item How can we reduce the number of architectural assumptions?
\end{itemize}
...
\begin{itemize}
\item How can we avoid building the wrong architecture?
\end{itemize}
...
\item How can we reduce the number of architectural assumptions?
\item How can we avoid building the wrong architecture?
\item How can we respond quicker to change in the market?
\item How can we deal with changing interfaces 
\end{itemize}
