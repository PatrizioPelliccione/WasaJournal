...
\chg{Addressing these concerns suggests two architectural views and viewpoints}{ which raises two main concerns:} %\eric{Should we then not split it into two viewpoints? Otherwise needs to be rephrased. I think we should have one viewpoint answering both questions.}
