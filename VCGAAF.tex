...
In order to define the stakeholders concerns, we identified a set of challenging scenarios through a number of workshops for elicitation and validation\ins{, which we then continued for defining the architecture framework and its viewpoints.} 
