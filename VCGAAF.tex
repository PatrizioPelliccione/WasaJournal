...
\begin{itemize}
    \item Found in the excel sheet  \patrizio{Do we have them in some deliverable that we can refer?}
\end{itemize}.
...
\begin{quote}
{User Story:} 
\emph{``The vehicle being in automated driving mode, is overtaken by a police car and prompted to pull over and stop at the roadside. The vehicle recognizes this and performs the maneuvers necessary.''} \patrizio{not much SoS. This is can be intersting if we want to show security needs: if the police can take control, any hacker will be able to take control ;)}
\end{quote}

\begin{quote}
{User Story:}
this can be nice also to show cars connected with cyclists: \url{http://analysis.tu-auto.com/auto-mobility/volvo-connecting-cars-cyclists-safer-mobility} and \url{http://www.mirror.co.uk/news/technology-science/technology/volvos-connected-helmet-warns-cyclists-4852610} 
\emph{``.''}
\end{quote}
