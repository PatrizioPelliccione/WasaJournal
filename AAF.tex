...
Uses of architecture frameworks include, but are not limited to~\cite{42010}\eric{should we be specific about how this is useful for VCC? E.g. systematically creating and evolving architecture?}: 
...
\ins{In this paper, we apply the viewpoint template above to describe three new viewpoints that we propose.
...
other viewpoints. \eric{despite being orthogonal, what does this viewpoint do? Description not on same level as other viewpoints.}
\end{itemize}
