...
\begin{itemize}
\item {\em Name}: name of the viewpoint.
\item {\em Overview}: overview of the viewpoint, by highlighting the motivation and importance for the domain to define this viewpoint.
\item {\em Concerns}: a listing of the architecture-related concerns framed by this viewpoint. This is
...
\item {\em Model languages}: For each type of model used, describe the language or modeling techniques to
...
\item {\em Model correspondence rules}: The viewpoint may specify model correspondence rules. Each one may be
documented here.
...
\item {\em Examples [Optional]}: Optional. This section provides examples for the reader.
\item {\em Sources}: What are the sources for this viewpoint, if any? This may include author,
