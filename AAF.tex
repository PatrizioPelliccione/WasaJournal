...
\caption{Terms and concepts beyond the standard (figure taken from~\cite{42010})}
\label{fig:42010}
\end{center}
\end{figure}

As shown in Figure~\ref{fig:42010}, an architecture framework is a prefabricated knowledge structure, identified by {\em architecture viewpoints}, that
