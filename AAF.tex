...
{Within this paper we refer to the definition of architecture suggested by the ISO/IEC/IEEE 42010:2011 standard~\cite{42010}, which defines the architecture as: ``{\em $<$system$>$fundamental concepts} {\em or properties of a system in its environment embodied in its elements,
